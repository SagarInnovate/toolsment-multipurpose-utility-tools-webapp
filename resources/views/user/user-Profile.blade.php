...
@section('head')
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Profile, ​&nbsp;Favorite Tools">
    <meta name="description" content="">
    <title>user-Profile</title>
    <link rel="stylesheet" href="{{ css_path('user-Profile.css', 'user') }}" media="screen">
...
@section('main-section')
    <section class="u-align-center u-clearfix u-section-3" id="sec-024f">
            ...
            <div class="u-container-style u-expanded-width u-gradient u-group u-radius-30 u-shape-round u-group-1"
                ...
                <div class="u-container-layout u-container-layout-1"><span
                        class="u-align-center u-file-icon u-icon u-text-white u-icon-1"><img
                            src="{{ img_path('511587-bbdb533d.png') }}" alt=""></span>
                    <div class="u-align-center u-form u-form-1">
                        <form action="#" method="POST"
                            ...
                            <div class="u-form-group u-form-name">
                                ...
                                <input type="text" placeholder="Enter your Name" id="name-b087" name="name"
                            ...
                            <div class="u-form-email u-form-group">
                                ...
                                <input type="email" placeholder="Enter a valid email address" id="email-b087"
                                    name="email"
                                    class="u-border-3 u-border-grey-10 u-input u-input-rectangle u-radius-9 u-white"
                                    required="">
                            </div>
                            ...
                            <div class="u-form-group u-form-phone u-form-group-4">
                                ...
                                <input type="tel" pattern="^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$"
                                    placeholder="Enter your phone (e.g. +14155552675)" id="phone-a711" name="phone"
                                    class="u-border-3 u-border-grey-10 u-input u-input-rectangle u-radius-9 u-white">
                            </div>
                            <div class="u-form-group u-form-textarea u-form-group-5">
                                ...
                                <textarea rows="4" cols="50" id="textarea-0d9c" name="textarea"
                                    class="u-border-3 u-border-grey-10 u-input u-input-rectangle u-radius-9 u-white" placeholder="About You"></textarea>
                            </div>
                            ...
                            <div class="u-align-center u-form-group u-form-submit">
                                <a href="#"
                                    class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-2 u-radius-17 u-btn-1">Update</a>
