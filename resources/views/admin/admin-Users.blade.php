...
@section('head')
    ...
    <link rel="stylesheet" href="{{ css_path('admin-Users.css', 'admin') }}" media="screen">
    ...
    <meta property="og:title" content="admin-Users">
...
<body class="u-body u-xl-mode" data-lang="en">
    ...
    @section('main-section')
        <section class="u-align-center u-clearfix u-gradient u-section-2" id="sec-288d">
                        ...
                        <div class="u-layout-row" style="">
                            ...
                            <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-2">
                                <div class="u-container-layout u-container-layout-2">
                                    <a href="{{ url('/ssadmin/users/create') }}" data-page-id="891812640"
        ...
        <section class="u-align-center u-clearfix u-gradient u-section-3" id="sec-ca7c">
                    ...
                    <tbody class="u-align-center u-table-body u-white u-table-body-1">
                        @foreach ($users as $record)
                            <tr style="height: 58px;">
                                ...
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $record->username }}
                                </td>
                                ...
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-9">
                                    <a class="u-border-none u-btn u-button-style u-gradient u-hover-palette-1-dark-1 u-none u-text-body-alt-color u-btn-1"
                                        href="{{ url('/ssadmin/users/' . $record->id . '/edit') }}"
                                        data-page-id="891812640">update</a>
                                </td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-10">
                                    <form action="{{ url('/ssadmin/users/' . $record->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a class="u-border-none u-btn u-button-style u-custom-color-2 u-hover-palette-1-dark-1 u-btn-2"
                                            onclick="dltclick({{ $record->id }})"><input style="display: none"
