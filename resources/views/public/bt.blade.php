...
@section('head')
    ...
    <link rel="stylesheet" href="{{ css_path('blog-post-template.css', 'public') }}" media="screen">
        ...
        @foreach ($a as $item)
          ...
          <div class="u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-1">
              <img alt="" class="u-image u-image-default u-image-1" data-image-width="2000" data-image-height="1333" src="{{ url('/public/Blog_Image/' . $item->image) }}">
