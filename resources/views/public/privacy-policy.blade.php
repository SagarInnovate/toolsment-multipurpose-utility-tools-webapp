...
@section('head')
    ...
    <meta name="keywords" content="privacy policy,privacy policy toolsment,toolment privacy policy">
    <meta name="description"
        content="This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Toolsment. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the Free Privacy Policy Generator.">
    <title>privacy-policy - Toolsment.com</title>
    <link rel="stylesheet" href="{{ css_path('privacy-policy.css', 'public') }}" media="screen">

   
@endsection
@section('main-section')
    <section class="u-clearfix u-section-1" id="sec-ba70">
        <div class="u-clearfix u-sheet u-sheet-1">
            <div class="u-clearfix u-custom-html u-expanded-width u-custom-html-1">
                <h1>Privacy Policy for Toolsment.com</h1>
                <p>At Toolsment, accessible from toolsment.com, one of our main priorities is the privacy of our visitors.
                    This Privacy Policy document contains types of information that is collected and recorded by Toolsment
                    and how we use it.</p>
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                    regards to the information that they shared and/or collect in Toolsment. This policy is not applicable
                ...
                <h2>Log Files</h2>
                <p>Toolsment follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Toolsment.
                </p>
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                    used in their respective advertisements and links that appear on Toolsment, which are sent directly to
                ...
                <p>Note that Toolsment has no access to or control over these cookies that are used by third-party
                    advertisers.</p>
                <h2>Third Party Privacy Policies</h2>
                <p>Toolsment's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                ...
                <p>Toolsment does not knowingly collect any Personal Identifiable Information from children under the age of
