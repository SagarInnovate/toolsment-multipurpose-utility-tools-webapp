...
@section('head')
    ...
    <meta name="keywords" content="terms and conditions,terms and conditions toolsment,toolsment terms and conditions">
    <meta name="description"
        content="Welcome to Toolsment!
These terms and conditions outline the rules and regulations for the use of Toolsment.com's Website, located at toolsment.com.
By accessing this website we assume you accept these terms and conditions. Do not continue to use Toolsment if you do not agree to take all of the terms and conditions stated on this page.">
    <title>terms-and-conditions - Toolsment.com</title>
    <link rel="stylesheet" href="{{ css_path('terms-and-conditions.css', 'public') }}" media="screen">
   

@endsection
@section('main-section')
    <section class="u-clearfix u-section-1" id="sec-163c">
        <div class="u-clearfix u-sheet u-sheet-1">
            <div class="u-clearfix u-custom-html u-expanded-width u-custom-html-1">
                <h2>
                    <strong>Terms and Conditions</strong>
                </h2>
                <p>Welcome to Toolsment!</p>
                <p>These terms and conditions outline the rules and regulations for the use of Toolsment.com's Website,
                    located at toolsment.com.</p>
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Toolsment if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>We employ the use of cookies. By accessing Toolsment, you agreed to use cookies in agreement with the
                    Toolsment.com's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, Toolsment.com and/or its licensors own the intellectual property rights for all
                    material on Toolsment. All intellectual property rights are reserved. You may access this from Toolsment
                    for your own personal use subjected to restrictions set in these terms and conditions.</p>
                <p>You must not:</p>
                <ul>
                    <li>Republish material from Toolsment</li>
                    <li>Sell, rent or sub-license material from Toolsment</li>
                    <li>Reproduce, duplicate or copy material from Toolsment</li>
                    <li>Redistribute content from Toolsment</li>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Toolsment.com does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of Toolsment.com,its
                    agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, Toolsment.com shall not be liable for the Comments
                ...
                <p>Toolsment.com reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant Toolsment.com a non-exclusive license to use, reproduce, edit and authorize others to
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                    ...
                    absence of Toolsment.com; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Toolsment.com. Please include your name, your
                ...
                <p>No use of Toolsment.com's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
                <h3>
